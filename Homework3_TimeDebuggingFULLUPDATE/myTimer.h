...
#define TIMER0              TIMER32_0_BASE //use these
#define TIMER1              TIMER32_1_BASE //use
...
#define TIMER0_COUNT        3000000 //3mil - (np)/f = amount of time on
#define TIMER1_COUNT        3000 // n =3000 now for 1ms on
